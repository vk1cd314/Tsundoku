...
class MainActivity : AppCompatActivity() {
    ...
    private fun populateLibrary() {
        val book1 = Manga("https:\\/\\/uploads.mangadex.org\\/covers\\/f9b82990-7198-4131-84bb-c952830f5ea7\\/6754b3ba-a9cd-4f07-89a5-ff4145f24605.jpg", "Nisioisin", "Bakemonogatari")
        mangaList.add(book1)
    }
